...
{
    /// <inheritdoc />
    public partial class BookingAndBookingOrder : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingCarts", x => x.BkId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.BkId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingCartBkId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookingItems_BookingCarts_BookingCartBkId",
                        column: x => x.BookingCartBkId,
                        principalTable: "BookingCarts",
                        principalColumn: "BkId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingItems_BookingCartBkId",
                table: "BookingItems",
                column: "BookingCartBkId");
